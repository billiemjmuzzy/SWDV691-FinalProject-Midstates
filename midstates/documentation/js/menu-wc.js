...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">midstates documentation</a>
                </li>
                    ...
                    <li class="chapter modules">
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        ...
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-1fe988fc36c130262625d05d45d2a826"' :
                                            ...
                                            <li class="link">
                                                <a href="components/InventoryCreateComponent.html"
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                <li class="link">
                                    <a href="injectables/InventoriesService.html" data-type="entity-link">InventoriesService</a>
                                </li>
                            </ul>
                        </li>
                    <li class="chapter">
